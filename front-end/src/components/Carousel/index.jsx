...
//? Variables
const img = ["/img/carousel.jpg", "/img/carousel2.jpg", "/img/carousel3.jpg"];
const options = {
  type: "loop",
  autoplay: true,
  interval: 3000,
...
const Carousel = () => {
  return (
    <div className="carousel">
      ...
      >
        <SplideSlide>
          <img className="item" src={img[0]} alt="Carousel 1" />
        </SplideSlide>
        <SplideSlide>
          <img className="item" src={img[1]} alt="Carousel 2" />
        </SplideSlide>
        <SplideSlide>
          <img className="item" src={img[2]} alt="Carousel 2" />
        </SplideSlide>
      </Splide>
    </div>
  );
